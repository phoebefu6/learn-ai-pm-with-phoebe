...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/PM session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      // This course's own session filenames. Renaming a page means renaming it here.
      var pages = mx
        ? ["a1-what-ai-changes-in-product.html",
           "a2-the-evidence-standard.html",
           "a3-specs-and-accountability.html",
           "a4-prioritisation-without-theatre.html",
           "a5-metrics-and-readouts.html",
           "a6-the-ai-assisted-product-org.html"]
        : ["b1-the-job-and-setup.html",
           "b2-evidenced-problem.html",
           "b3-research-synthesis.html",
           "b4-jobs-and-opportunity-tree.html",
           "b5-the-spec-and-the-scorer.html",
           "b6-prioritisation-tradeoffs.html",
           "b7-metrics-and-instrumentation.html",
           "b8-experiments-and-readouts.html",
           "b9-roadmap-narrative.html",
           "b10-capstone-one-decision.html"];
